...
элемент с классом _back-right_ — прямо напротив пользователя. Что бы исправить
...
Это правило задает ширину стены равной 500 пикселей, что равно ширине сцены,
высоту равной 120 пикселей и светло-коричневый цвет фона. Элемент поворачивается
на 90 градусов и смещается по оси X. У него есть `border` шириной 6 пикселей,
что бы создать иллюзию объема.
