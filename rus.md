...
псевдо-элемент, который используем для получения нужного нам эффекта.
...
платформ. Эти спаны были добавлены что бы после установки в качестве фона
...
получить используя псевдо-элементы, но так как анимация псевдо-элементом
...
выход. Что бы создать дверь я использовал один единственный элемент с несколькими
...
что бы позиционировать ее у правой стены:
...
все анимации длительностью 10 секунд. Я добавил в код комментарии, что бы
...
Производительно на разных устройствах неплохая (с учетом нагрузки, которую
